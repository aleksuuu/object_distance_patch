...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 676.756623268127441, 557.142854154109955, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 289.285721182823181, 926.428593516349792, 50.5, 22.0 ],
					"text" : "pan2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 313.605439186096191, 156.462583541870117, 166.0, 20.0 ],
									"text" : "modified from 'ezduck' by raja"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 12.0, 227.0, 29.5, 22.0 ],
									"text" : "f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 79.901965737342834, 134.313733816146851, 36.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 8.0, 48.979591369628906, 40.0, 22.0 ],
									"text" : "t b f 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 54.0, 79.0, 63.0, 22.0 ],
									"text" : "1, 0 5 -0.5"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 54.0, 105.102039813995361, 58.0, 22.0 ],
									"text" : "curve~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 58.0, 344.0, 30.0, 30.0 ]
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 89.5, 220.0, 180.0, 220.0, 180.0, 75.0, 128.5, 75.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-23", 0 ],
									"midpoints" : [ 128.5, 107.0, 63.5, 107.0 ],
									"source" : [ "obj-25", 0 ]
								}
...
,
					"patching_rect" : [ 146.916671454906464, 455.555562615394592, 57.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 149.112429857254028, 152.662725806236267, 55.0, 22.0 ],
					"text" : "stripnote"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.0, 884.0, 84.0, 22.0 ],
					"text" : "r #0-trigEnv"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 228.571434020996094, 926.428593516349792, 50.5, 22.0 ],
					"text" : "pan2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.500009119510651, 777.0, 62.0, 22.0 ],
					"text" : "r #0-vel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.278476655483246, 268.987338244915009, 62.0, 22.0 ],
					"text" : "r #0-vel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.916671454906464, 510.837474048137665, 86.0, 22.0 ],
					"text" : "s #0-trigEnv"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 729.0, 703.0, 22.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 729.0, 673.0, 29.5, 22.0 ],
					"text" : "del"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 728.873248994350433, 643.661980271339417, 29.5, 22.0 ],
					"text" : "- 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 90.000009119510651, 741.0, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 146.916671454906464, 483.33334082365036, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.500009119510651, 805.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.278476655483246, 296.835439145565033, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.063285827636719, 268.987338244915009, 137.0, 22.0 ],
					"text" : "r #0-trigAnotherSamp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 678.0, 729.0, 139.0, 22.0 ],
					"text" : "s #0-trigAnotherSamp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 678.0, 610.0, 121.0, 22.0 ],
					"text" : "expr random(75\\,125)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 678.0, 662.0, 29.5, 22.0 ],
					"text" : "del"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 676.756623268127441, 531.333349168300629, 141.0, 22.0 ],
					"text" : "expr random(20\\,$i1-200)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "" ],
					"patching_rect" : [ 613.756623268127441, 460.846567988395691, 40.0, 22.0 ],
					"text" : "t b l l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 613.756623268127441, 495.073926150798798, 113.5, 22.0 ],
					"text" : "info~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.500004470348358, 541.333349466323853, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 90.151507198810577, 616.666612267494202, 377.0, 22.0 ],
					"text" : "groove~ vox.1 2 @timestretch 1 @mode monophonic @quality better"
				}
